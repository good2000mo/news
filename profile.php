...
// pun_bbcode
if (file_exists(FORUM_ROOT.'extensions/pun_bbcode/lang/'.$forum_user['language'].'/pun_bbcode.php'))
	include FORUM_ROOT.'extensions/pun_bbcode/lang/'.$forum_user['language'].'/pun_bbcode.php';
else
	include FORUM_ROOT.'extensions/pun_bbcode/lang/English/pun_bbcode.php';
