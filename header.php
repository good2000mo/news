...
if (!$forum_config['attach_disable_attach'] && in_array(FORUM_PAGE, array('viewtopic', 'postedit', 'attachment-preview')))
			{
				if (is_dir(FORUM_ROOT.'extensions/pun_attachment/styles/'.$forum_user['style']))
				{
					$forum_head['style_attch'] = '<link rel="stylesheet" type="text/css" media="screen" href="'.$base_url.'/extensions/pun_attachment/style/'.$forum_user['style'].'/'.$forum_user['style'].'.css" />';
					$forum_head['style_attch_css'] = '<link rel="stylesheet" type="text/css" media="screen" href="'.$base_url.'/extensions/pun_attachment/style/'.$forum_user['style'].'/'.$forum_user['style'].'_cs.css" />';
				}
				else
				{
					$forum_head['style_attch'] = '<link rel="stylesheet" type="text/css" media="screen" href="'.$base_url.'/extensions/pun_attachment/style/Oxygen/Oxygen.css" />';
					$forum_head['style_attch_css'] = '<link rel="stylesheet" type="text/css" media="screen" href="'.$base_url.'/extensions/pun_attachment/style/Oxygen/Oxygen_cs.css" />';
				}
			}
// pun_attachment
...
if ($forum_user['pun_bbcode_enabled'] && ((FORUM_PAGE == 'viewtopic' && $forum_config['o_quickpost']) || in_array(FORUM_PAGE, array('post', 'postedit'))))
{
	...
	$forum_head['style_pun_bbcode'] = '<link rel="stylesheet" type="text/css" media="screen" href="'.$base_url.'/extensions/pun_bbcode/styles.css" />';
	$forum_head['js_pun_bbcode'] = '<script type="text/javascript" src="'.$base_url.'/extensions/pun_bbcode/scripts.js"></script>';
}
// pun_bbcode
