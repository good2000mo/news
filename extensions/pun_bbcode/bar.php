...
<?php
	...
	if ($forum_user['pun_bbcode_use_buttons'])
	{
		if (file_exists(FORUM_ROOT.'extensions/pun_bbcode/buttons/'.$forum_user['style'].'/'))
			$buttons_path = $base_url.'/extensions/pun_bbcode/buttons/'.$forum_user['style'];
		else
			$buttons_path = $base_url.'/extensions/pun_bbcode/buttons/Oxygen';
	}
